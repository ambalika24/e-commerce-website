        ...
        <div className="info__container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <select name="choose_product" id="choose_product" multiple>
                    <option value="tablet">Bedsheet</option>
                    <option value="syrup">door mat</option>
                    <option value="powder">Soap</option>
                    <option value="drink">Plastic Items</option>
                    <option value="cream">Wiper</option>
                </select>
                ...
                className="info__signInButton">Done</button></center>
            </form>
            <p><input type="checkbox" required/> I agree to Amazon's conditions of use & sale. Please see our Privacy
